...
public class CustomAuthenticationEntryPoint implements AuthenticationEntryPoint {
    ...
    public void commence(HttpServletRequest request, HttpServletResponse res, AuthenticationException authException) throws IOException, ServletException {
		...
		Response<Response> response = new Response<Response>(String.valueOf(Calendar.getInstance().getTime()),String.valueOf(HttpStatus.UNAUTHORIZED.value()),true,authException.getMessage(),null,request.getRequestURI());
