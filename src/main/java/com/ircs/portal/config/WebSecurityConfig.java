...
import com.ircs.portal.setup.entity.UserPrincipal;
		...
		http.cors().and()
				...
				.authorizeHttpRequests((authorize) -> authorize
						.requestMatchers("/api/authorize", "/api/employee/verify", "/api/ward/**", "/api/district/**",
								"/api/region/**","/api/token")
						.permitAll()
						.requestMatchers("/api/user-category/**", "/api/terms-of-service/**", "/api/user/create")
						.permitAll().requestMatchers("/api/user/verify-email/**", "/api/user/verify-phone-number/**")
						.permitAll().requestMatchers("/api/user/resend/phone-number/verification/token/**").permitAll()
						.requestMatchers("/api/user/request/password-reset-link/**", "/api/user/reset-password")
						.permitAll().requestMatchers("/api/user/verify/password-reset-link/**","/api/employee/**").permitAll().anyRequest()
						.authenticated())
				.csrf(csrf -> csrf.ignoringRequestMatchers(endpointsMatcher)
						.ignoringRequestMatchers("/api/authorize", "/api/employee/**", "/api/ward/**",
								"/api/district/**", "/api/region/**","/api/token")
						.ignoringRequestMatchers("/api/user-category/**", "/api/terms-of-service/**",
								"/api/user/create")
